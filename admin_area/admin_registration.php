...
<body>
    <div class="container-fluid m-3">
            <h2 class="text-center mb-5 text-muted">Admin Registration</h2>
                ...
                <div class="col-lg-6 col-xl-4">
                    <form action="" method="post">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="email" id="email" name="email" placeholder="Enter your Email here:" required="required" class="form-control">
                        </div>
                        <div class="form-outline mb-4">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="password" id="confirm_password" name="confirm_password" placeholder="Enter your Confirm password here:" required="required" class="form-control">
                        </div>
                        <div>
