    ...
    <tbody class="bg-secondary text-light">
        ...
        <tr class="text-center">
            ...
            <td><a href='index.php?edit_brands=<?php echo $brand_id; ?>' class='text-success'><i class='fa-solid fa-pen-to-square'></i></a></td>
                ...
                <td><a href='index.php?delete_brands=<?php echo $brand_id; ?>' type="button" class=" text-success" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'></i></a></td>
        </tr>
