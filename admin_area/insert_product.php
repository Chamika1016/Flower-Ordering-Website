...
<head>
    ...
    <style>
        body{
            background: #F8EDFF;
            background-image: linear-gradient(#F8EDFF,rgba(16, 17, 17, 0.616)),url(./images/Template.png);
        }
    </style>
</head>
<body>
    <div class="container mt-3">
        <h1 class="text-center text-muted">Insert Products</h1>
        <!-- form -->
        ...
        <!-- title -->
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <a href="./index.php" class="btn btn-info mb-3 px-3">Back</a>
