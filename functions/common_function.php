<?php
    ...
    function get_unique_brands(){
        ...
        $num_of_rows=mysqli_num_rows($result_query);
        if ($num_of_rows==0) {
            echo "<h2 class='text-center text-danger'>This Brand is not availbale for service..</h2>";
        }
        // $row=mysqli_fetch_assoc($result_query);
    ...
    function search_product(){
        ...
        $num_of_rows=mysqli_num_rows($result_query);
        if ($num_of_rows==0) {
            echo "<h2 class='text-center text-danger'>No Results match.No product found found on this category..</h2>";
        }
    ...
    while ($row=mysqli_fetch_assoc($result_query)) {
        ...
        <div class='card'>
            ...
            <div class='card-body'>
                ...
                <p class='card-text'>Price:Rs.$product_price/=</p>
                <a href='index.php?add_to_cart=$product_id' class='btn btn-info'>Add to cart</a>
                <a href='display_all.php' class='btn btn-secondary'>Go To Home</a>
            </div>
        </div>
        </div>
...
function cart(){
    if (isset($_GET['add_to_cart'])) {
        ...
        $num_of_rows=mysqli_num_rows($result_query);
        if ($num_of_rows>0) {
            echo "<script>alert('This item is already available in the cart')</script>";
            ...
            if (!isset($_GET['my_orders'])) {
                if (!isset($_GET['delete_account'])) {
                    ...
                    if ($row_count>0) {
                        ...
                        <h1 class='btn btn-info mb-3 px-3'><a href='../display_all.php?my_orders'>Explore Products</a></h1>";
